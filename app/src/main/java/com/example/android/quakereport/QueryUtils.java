...
public class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            // Getting JSON array
            JSONArray featuresEarthquakes = jsonObject.getJSONArray("features");
            // loop through all array
            for(int i = 0; i < featuresEarthquakes.length(); i++){
                JSONObject features_array = featuresEarthquakes.getJSONObject(i);
                JSONObject properties = features_array.getJSONObject("properties");
                double magnitude = properties.getDouble("mag");
                String place  = properties.getString("place");
                long time = properties.getLong("time");
                String url = properties.getString("url");
                // Object to Earthquake
